...
public class EditedkNN implements Classifier{
/*
 ...
 * */
	...
	public EditedkNN(int k){
		this.train=new DataSet();
		this.k=k;
	}
	
	public void train(DataSet train){
		//System.out.println("train(DataSet train)");
	...
	public DataSet editedKNN(DataSet train){
		//System.out.println("DataSet editedKNN(DataSet train)");
	...
	public int classify(Example example1){
		//System.out.println("classify(Example example1)");
	...
	public Performance classify(DataSet test){
		//System.out.println("Performance classify(DataSet test)");
	...
	double getDistance(Example e1, Example e){
		//System.out.println("double getDistance(Example e1, Example e)");
		double distance=0.0;
	...
	public static void main(String[] args) throws Exception{
		...
		if(arrArgs.contains("-T")){
			...
			EditedkNN classifier=new EditedkNN();
			classifier.train(t1.train);
			System.out.println("# of examples="+classifier.train.examples.size());
